    ...
    <>
        ...
        {floatingComposer && (
            ...
            >
                {/* 顶部：拖拽手柄区 */}
                <div
                    className="flex items-center justify-between px-4 pt-3 pb-2 cursor-move select-none"
                    onMouseDown={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                ...
                >
                    <div className="flex items-center gap-2">
                        <button
                            type="button"
                            className="composer-style-btn flex h-14 w-14 shrink-0 flex-col items-center justify-center gap-0.5 rounded-xl bg-[#2c2c30] text-[#a3a3a8] transition hover:bg-[#36363a] hover:text-[#b8b8bd] active:scale-[0.98]"
                            title="风格"
                        ...
                        >
                            <span className="text-[17px] font-light leading-none tracking-tight" aria-hidden>
                                +
                            </span>
                            <span className="text-[11px] font-medium leading-none">风格</span>
                        </button>
                        <div className="text-[12px] text-white !text-white ml-2">模式：{floatingTitle}</div>
                    </div>
                    <button
                        type="button"
                        className="w-9 h-9 rounded-xl text-white hover:bg-white/5 transition"
                        onMouseDown={(e) => e.stopPropagation()}
                        onClick={(e) => {
                            e.stopPropagation();
                ...
                <div className="px-4 pb-3">
                  <div className="relative w-full overflow-hidden rounded-xl border border-white/10 bg-zinc-800/90 min-h-[176px] flex flex-col">
